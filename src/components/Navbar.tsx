const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-background/92 backdrop-blur-xl border-b border-border h-[60px] flex items-center justify-between px-5 md:px-10">
    ...
    <div className="hidden md:flex items-center gap-8">
      ...
      <a href="#" className="text-[13px] text-muted-foreground hover:text-foreground transition-colors">Sign in</a>
      <a href="#" className="bg-primary text-primary-foreground px-5 py-2 rounded-sm text-[13px] font-semibold hover:brightness-110 transition-all">
        Start free trial
      </a>
    </div>
  </nav>
